...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/analytics/employees/top-performers": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Max number of performers",
                        "name": "limit",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/analytics/employees/{id}/metrics": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/analytics/projects/{id}/metrics": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/employees/profiles/{id}/skills": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AddSkillToEmployeeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/employees/profiles/{id}/skills/{skillId}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ChangeUserStatusRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateSkillRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/projects": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Project status (0-3)",
                        "name": "status",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AddMemberToProjectRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/projects/{id}/tasks/{taskId}/assign": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/projects/{id}/tasks/{taskId}/move": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        "models.AddMemberToProjectRequest": {
            "type": "object",
            "required": [
                "user_id"
            ],
        ...
        "models.AddSkillToEmployeeRequest": {
            "type": "object",
            "required": [
                "skill_id"
            ],
        ...
        "models.ChangeUserStatusRequest": {
            "type": "object",
            "required": [
                "status"
            ],
