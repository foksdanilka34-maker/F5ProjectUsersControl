...
func (l *loginCore) CreateDepartment(ctx context.Context, name string) (*emp.Department, error) {
	storage.Logger.Info("CreateDepartment called", zap.String("name", name))
	if name == "" {
	...
	storage.Logger.Info("Department created successfully", zap.String("id", department.ID))
	return department, nil
}

func (l *loginCore) GetDepartment(ctx context.Context, id string) (*emp.Department, error) {
	storage.Logger.Info("GetDepartment called", zap.String("id", id))
	if id == "" {
	...
	storage.Logger.Info("Department retrieved successfully", zap.String("id", id))
	return department, nil
}

func (l *loginCore) ListDepartments(ctx context.Context) ([]*emp.Department, error) {
	storage.Logger.Info("ListDepartments called")
	departments, err := l.employee.ListDepartments(ctx)
	if err != nil {
		storage.Logger.Error("failed to list departments", zap.Error(err))
		return nil, err
	}
	storage.Logger.Info("Departments listed successfully", zap.Int("count", len(departments)))
	return departments, nil
}

func (l *loginCore) UpdateDepartment(ctx context.Context, id, name string) (*emp.Department, error) {
	storage.Logger.Info("UpdateDepartment called", zap.String("id", id), zap.String("name", name))
	if id == "" {
		return nil, fmt.Errorf("department ID cannot be empty")
	}
	if name == "" {
	...
	storage.Logger.Info("Department updated successfully", zap.String("id", id))
	return department, nil
}

func (l *loginCore) DeleteDepartment(ctx context.Context, id string) error {
	storage.Logger.Info("DeleteDepartment called", zap.String("id", id))
	if id == "" {
	...
	storage.Logger.Info("Department deleted successfully", zap.String("id", id))
	return nil
}

func (l *loginCore) CreatePosition(ctx context.Context, name string) (*emp.Position, error) {
	storage.Logger.Info("CreatePosition called", zap.String("name", name))
	if name == "" {
	...
	storage.Logger.Info("Position created successfully", zap.String("id", position.ID))
	return position, nil
}

func (l *loginCore) GetPosition(ctx context.Context, id string) (*emp.Position, error) {
	storage.Logger.Info("GetPosition called", zap.String("id", id))
	if id == "" {
	...
	storage.Logger.Info("Position retrieved successfully", zap.String("id", id))
	return position, nil
}

func (l *loginCore) ListPositions(ctx context.Context) ([]*emp.Position, error) {
	storage.Logger.Info("ListPositions called")
	positions, err := l.employee.ListPositions(ctx)
	if err != nil {
		storage.Logger.Error("failed to list positions", zap.Error(err))
		return nil, err
	}
	storage.Logger.Info("Positions listed successfully", zap.Int("count", len(positions)))
	return positions, nil
}

func (l *loginCore) UpdatePosition(ctx context.Context, id, name string) (*emp.Position, error) {
	storage.Logger.Info("UpdatePosition called", zap.String("id", id), zap.String("name", name))
	if id == "" {
		return nil, fmt.Errorf("position ID cannot be empty")
	}
	if name == "" {
	...
	storage.Logger.Info("Position updated successfully", zap.String("id", id))
	return position, nil
}

func (l *loginCore) DeletePosition(ctx context.Context, id string) error {
	storage.Logger.Info("DeletePosition called", zap.String("id", id))
	if id == "" {
	...
	storage.Logger.Info("Position deleted successfully", zap.String("id", id))
	return nil
}

func (l *loginCore) CreateSkill(ctx context.Context, name string) (*emp.Skill, error) {
	storage.Logger.Info("CreateSkill called", zap.String("name", name))
	if name == "" {
	...
	storage.Logger.Info("Skill created successfully", zap.String("id", skill.ID))
	return skill, nil
}

func (l *loginCore) ListSkills(ctx context.Context) ([]*emp.Skill, error) {
	storage.Logger.Info("ListSkills called")
	skills, err := l.employee.ListSkills(ctx)
	if err != nil {
		storage.Logger.Error("failed to list skills", zap.Error(err))
		return nil, err
	}
	storage.Logger.Info("Skills listed successfully", zap.Int("count", len(skills)))
	return skills, nil
}

func (l *loginCore) AddSkillToEmployee(ctx context.Context, employeeID, skillID string) error {
	storage.Logger.Info("AddSkillToEmployee called", zap.String("employeeID", employeeID), zap.String("skillID", skillID))
	if employeeID == "" {
	...
	storage.Logger.Info("Skill added to employee successfully", zap.String("employeeID", employeeID), zap.String("skillID", skillID))
	return nil
}

func (l *loginCore) RemoveSkillFromEmployee(ctx context.Context, employeeID, skillID string) error {
	storage.Logger.Info("RemoveSkillFromEmployee called", zap.String("employeeID", employeeID), zap.String("skillID", skillID))
	if employeeID == "" {
		return fmt.Errorf("employee ID cannot be empty")
	}
	if skillID == "" {
	...
	storage.Logger.Info("Skill removed from employee successfully", zap.String("employeeID", employeeID), zap.String("skillID", skillID))
	return nil
}
