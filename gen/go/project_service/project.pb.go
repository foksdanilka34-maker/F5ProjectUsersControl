...
var file_project_service_project_proto_depIdxs = []int32{
	...
	24, // 9: project.Task.started_at:type_name -> google.protobuf.Timestamp
	24, // 10: project.Task.completed_at:type_name -> google.protobuf.Timestamp
	24, // 11: project.CreateProjectRequest.due_date:type_name -> google.protobuf.Timestamp
	...
	24, // 15: project.UpdateProjectRequest.due_date:type_name -> google.protobuf.Timestamp
	1,  // 16: project.CreateTaskRequest.priority:type_name -> project.TaskPriority
	24, // 17: project.CreateTaskRequest.due_date:type_name -> google.protobuf.Timestamp
	...
	24, // 20: project.UpdateTaskRequest.due_date:type_name -> google.protobuf.Timestamp
	...
	6,  // 26: project.ProjectService.CreateProject:input_type -> project.CreateProjectRequest
	7,  // 27: project.ProjectService.GetProject:input_type -> project.GetProjectRequest
	8,  // 28: project.ProjectService.ListProjects:input_type -> project.ListProjectsRequest
	10, // 29: project.ProjectService.UpdateProject:input_type -> project.UpdateProjectRequest
	11, // 30: project.ProjectService.DeleteProject:input_type -> project.DeleteProjectRequest
	12, // 31: project.ProjectService.CreateTask:input_type -> project.CreateTaskRequest
	13, // 32: project.ProjectService.GetTask:input_type -> project.GetTaskRequest
	14, // 33: project.ProjectService.UpdateTask:input_type -> project.UpdateTaskRequest
	15, // 34: project.ProjectService.DeleteTask:input_type -> project.DeleteTaskRequest
	16, // 35: project.ProjectService.MoveTask:input_type -> project.MoveTaskRequest
	17, // 36: project.ProjectService.AssignTask:input_type -> project.AssignTaskRequest
	18, // 37: project.ProjectService.ListTasksByProject:input_type -> project.ListTasksByProjectRequest
	20, // 38: project.ProjectService.AddMemberToProject:input_type -> project.AddMemberToProjectRequest
	21, // 39: project.ProjectService.RemoveMemberFromProject:input_type -> project.RemoveMemberFromProjectRequest
	22, // 40: project.ProjectService.ListProjectMembers:input_type -> project.ListProjectMembersRequest
	3,  // 41: project.ProjectService.CreateProject:output_type -> project.Project
	3,  // 42: project.ProjectService.GetProject:output_type -> project.Project
	9,  // 43: project.ProjectService.ListProjects:output_type -> project.ListProjectsResponse
	3,  // 44: project.ProjectService.UpdateProject:output_type -> project.Project
	25, // 45: project.ProjectService.DeleteProject:output_type -> google.protobuf.Empty
	4,  // 46: project.ProjectService.CreateTask:output_type -> project.Task
	4,  // 47: project.ProjectService.GetTask:output_type -> project.Task
	4,  // 48: project.ProjectService.UpdateTask:output_type -> project.Task
	25, // 49: project.ProjectService.DeleteTask:output_type -> google.protobuf.Empty
	4,  // 50: project.ProjectService.MoveTask:output_type -> project.Task
	4,  // 51: project.ProjectService.AssignTask:output_type -> project.Task
	19, // 52: project.ProjectService.ListTasksByProject:output_type -> project.ListTasksByProjectResponse
	25, // 53: project.ProjectService.AddMemberToProject:output_type -> google.protobuf.Empty
	25, // 54: project.ProjectService.RemoveMemberFromProject:output_type -> google.protobuf.Empty
	23, // 55: project.ProjectService.ListProjectMembers:output_type -> project.ListProjectMembersResponse
