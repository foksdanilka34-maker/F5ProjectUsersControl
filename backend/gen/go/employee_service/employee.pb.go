...
const file_employee_service_employee_proto_rawDesc = "" +
	"\n" +
	"\x1femployee_service/employee.proto\x12\temployees\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x82\x04\n" +
	"\aProfile\x12\x0e\n" +
	...
	"\thire_date\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\bhireDate\x125\n" +
	"\n" +
	...
	"\rdepartment_id\x18\x05 \x01(\tH\x00R\fdepartmentId\x88\x01\x01\x127\n" +
	...
	"\vposition_id\x18\x04 \x01(\tH\x01R\n" +
	"positionId\x88\x01\x01B\x10\n" +
...
func file_employee_service_employee_proto_init() {
	...
	file_employee_service_employee_proto_msgTypes[5].OneofWrappers = []any{}
